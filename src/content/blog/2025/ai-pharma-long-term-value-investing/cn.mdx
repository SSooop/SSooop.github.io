...
imageAlt: "一枚指南针穿越市场泡沫与波动，指向分子结构和长期科学价值"
imageCaption: "穿越短期市场噪声，沿着科学价值与患者价值的长期路径前行"
...
<ArticleImage
  src={aiMoneyMachine}
  alt="OpenAI、Nvidia、Microsoft、Oracle、AMD等公司之间的AI投资、算力和服务关系网络"
  caption="AI资本关系网络：硬件采购、投资、云服务与风险资本在少数核心公司之间形成交错回路"
  source="Bloomberg News reporting，2025年10月"
...
<ArticleImage
  ...
  alt="水力、蒸汽、电力、内燃机以及信息通信技术依次沿S曲线发展的时间线"
  caption="技术革命沿着相似的扩散曲线彼此接续：从水力、蒸汽和电力，到内燃机与信息技术"
...
<ArticleImage
  src={technologyCycle}
  alt="Carlota Perez技术革命周期图，展示安装期、转折点和展开期，以及爆发、狂热、协同和成熟阶段"
  caption="每次技术浪潮都从安装期的爆发与狂热，经过崩溃和制度调整，再进入展开期的协同与成熟"
  source="Carlota Perez，经 Jam 整理"
