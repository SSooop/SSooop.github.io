...
imageAlt: "AI原生团队从本体论、认识论到方法论的三层递进架构"
imageCaption: "AI原生团队的本体论、认识论与方法论三层架构"
imageSource: "智药深瞳（作者原创，SVG代码重绘）"
---
...
<ArticleImage
  ...
  alt="Sam Altman关于未来将出现单人十亿美元公司的观点"
  caption="Sam Altman认为，AI将使单人十亿美元公司成为可能"
...
<ArticleImage
  ...
  alt="1972年前后的Honeywell 6180 Multics计算机机房"
  caption="Honeywell 6180（GE 600系列Multics计算机），约摄于1972年"
...
<ArticleImage
  ...
  alt="IBM System/360发布活动：纽约中央车站的发布会专列指示牌与IBM董事长Thomas J. Watson Jr."
  caption="1964年4月7日，IBM以专列将记者从纽约送往波基普西，并正式发布System/360"
...
<ArticleImage
  ...
  alt="Frederick P. Brooks经典著作《人月神话》周年纪念版封面"
  caption="《人月神话》周年纪念版：Brooks对大型软件工程与组织协作的经典总结"
...
<ArticleImage
  ...
  alt="从Scrum、敏捷开发到Docker、Kubernetes和GitOps的软件工程与DevOps演进时间线"
  caption="1995—2017年软件工程与DevOps关键事件时间线"
...
<ArticleImage
  ...
  alt="AI原生团队从本体论、认识论到方法论的三层递进架构"
  caption="AI原生团队的三层架构：由共享的数据与语义，经集体认知，沉淀为可复用的方法与决策"
  source="智药深瞳（作者原创，SVG代码重绘）"
  sourcePrefix="来源"
  variant="full"
  aspect="16:9"
  tone="plain"
...
<ArticleImage
  src={labiiAiOverview}
  alt="Labii ELN与LIMS平台中的AI集成示意"
  caption="Labii展示的AI与ELN、LIMS及实验数据工作流集成"
  source="Labii"
...
<ArticleImage
  ...
  alt="从1900年至2025年的人工智能发展历史时间线"
  caption="人工智能发展时间线：从早期计算基础、两次AI寒冬到Transformer、ChatGPT与DeepSeek"
