...
imageAlt: "LLM驱动的自主智能体系统总览，展示规划、记忆、工具与行动之间的关系"
imageCaption: "LLM驱动的自主智能体由规划、记忆与工具使用三类核心模块构成"
...
<ArticleImage
  ...
  alt="LLM驱动的自主智能体系统总览，中心Agent连接规划、记忆、工具与行动模块"
  caption="LLM驱动的自主智能体系统：Planning、Memory与Tool Use共同支撑Agent行动"
...
<ArticleImage
  ...
  alt="Dify Workflow产品界面，展示问题分类、知识检索、LLM与直接回答节点组成的可视化流程"
  caption="Dify Workflow通过可视化节点将模型能力、知识检索与确定性流程连接起来"
  source="Dify"
...
<ArticleImage
  ...
  alt="Agent提示词界面中写入依赖检查与项目初始化等确定性Workflow命令"
  caption="当确定性的依赖检查和项目初始化被直接写入Prompt，Agent实际上开始承担Workflow的角色"
  source="智药深瞳（界面截图）"
  sourcePrefix="来源"
  variant="compact"
  tone="ink"
...
<ArticleImage
  ...
  alt="Dify迭代节点设置界面，输入与输出变量均要求为数组"
  caption="Dify迭代节点把输入、输出变量约束显式固化在Workflow配置中"
  source="智药深瞳（Dify界面截图）"
  sourcePrefix="来源"
  variant="compact"
  tone="ink"
/>
