...
imageAlt: "以大象比喻生物学增强子研究的多源证据整合示意图"
imageCaption: "增强子研究需要整合序列、细胞类型、三维构象、扰动实验与体内验证等多种观测维度"
...
<ArticleImage
  src={agentTrends2025}
  alt="2025年AI Agent趋势信息图，展示语音智能体、Agentic RAG、智能体协议、计算机使用智能体、编程智能体与深度研究智能体"
  caption="2025年AI Agent趋势：Voice、Agentic RAG、协议、CUA、Coding与Deep Research"
...
<ArticleImage
  ...
  alt="AI Agent连接基因组学、生物信息学、分子生物学、蛋白质工程、结构生物学、细胞生物学、药物发现与人类科学家的协作体系示意图"
  caption="AI Agent与不同领域人类科学家的协作模型：增强复杂研究的系统化能力，而非取代科学家"
  source="智药深瞳（AI生成）"
  sourcePrefix="来源"
  variant="compact"
  tone="plain"
...
<ArticleImage
  ...
  alt="以大象比喻生物学增强子研究的多源证据整合示意图，涵盖序列、细胞类型、三维构象、MPRA、CRISPR筛选与体内验证"
  caption="增强子研究需要整合序列、细胞类型、三维构象、扰动实验与体内验证等多种观测维度"
