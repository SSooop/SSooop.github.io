...
imageAlt: "AI原生的Context条件化Protein Docking架构，融合物理条件、进化信息、结构生成与实验反馈"
imageCaption: "Context不是静态附加输入，而是在采样、压缩、结构解码与判别反馈之间循环流动"
...
<ArticleImage
  ...
  alt="双表位抗体通过cis或trans结合产生高亲合力、通路抑制、受体聚集、免疫效应及内化降解的机制示意图"
  caption="双表位抗体的作用机制：从cis/trans亲合力增强，到受体聚集、效应功能与溶酶体转运"
...
<ArticleImage
  ...
  alt="冷冻电子断层成像揭示P17-IgG连接SARS-CoV-2刺突三聚体的十一种双价结合模式及病毒表面组装"
  caption="P17-IgG通过多种双价结合模式连接相邻刺突三聚体，并改变病毒表面的高阶组装"
...
<ArticleImage
  ...
  alt="Chai-1技术报告中抗体抗原DockQ成功率对比，展示不同接触与表位残基约束对预测质量的提升"
  caption="Chai-1消融结果：更明确的表位残基约束显著提高抗体—抗原DockQ成功率"
...
<ArticleImage
  ...
  alt="Context条件化Protein Docking闭环架构，物理条件与进化信息分别编码，经MMDiT融合和结构解码后由判别反馈循环优化"
  caption="AI原生Docking架构：物理证据与进化Context分路编码，在结构生成后通过判别器和条件复现形成反馈闭环"
